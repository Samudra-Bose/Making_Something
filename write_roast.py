...
function EditorialRoastOption({ level, title, desc, current, onSelect }: any) {
  ...
  return (
    <button 
      ...
      className={group flex flex-col text-left border-l-2 py-4 pl-6 transition-all duration-500  focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-drift-foreground}
    >
...
"""
with open("src/worlds/Roast.tsx", "w", encoding="utf-8") as f:
    f.write(content)
